...
import ar.edu.uns.cs.ed.tdas.tps.tp5.ej2.ListaDobleEnlazadaCentinela;

public class DigrafoListaAdyacencias<V,E> implements GraphD<V,E>{
    // Atributos
    protected ListaDobleEnlazadaCentinela<Vertice<V,E>> nodos;
    protected ListaDobleEnlazadaCentinela<Arco<V,E>> arcos;
    // Constructor
    public DigrafoListaAdyacencias(){
